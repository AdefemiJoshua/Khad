      ...
      <div className={styles.OurPartnersSection}>
        ...
        <div className={styles.OurPartnersContentContainer}>
          ...
          <div className={styles.OurPartnersWriteUp}>
            ...
            <p>
            In order to bring essential commodities to the global market, Khadesh Global Integrated Services Limited is pursuing a long-term strategy of development, acquisition, operation, expansion, and optimisation of advanced streams and channels. These include mining and exploration, industrial processing, bulk commodity storage and terminals (encompassing both soft and hard commodities), pipeline throughput, trans-loading, transshipment, and multi-modal transportation of petroleum oil products and natural gas, agricultural commodity This is exactly in line with our objective of producing optimal value for varied commodity portfolios throughout the supply chain.
</p>
            <p>
